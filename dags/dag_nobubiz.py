...
# Instantiate the DAG
dag = DAG(
    'dag_ingest_cybertrack_nobubiz_v_transaction',
...
def extract_from_mssql(**kwargs):
    ...
    sql = "SELECT * FROM raw_data.cybertrack_nobubiz_v_transaction;"
...
def load_to_postgresql(**kwargs):
    ...
    insert_query = """
    INSERT INTO raw_data.cybertrack_nobubiz_v_transaction (
        "Id",
        "MPANID",
        "NMID",
        "MerchantID",
