...
# Instantiate the DAG
dag = DAG(
    'dag_ingest_cybertrack_superapps_v_billpayment',
...
def extract_from_mssql(**kwargs):
    ...
    sql = "SELECT * FROM raw_data.cybertrack_superapps_v_billpayment;"
...
def load_to_postgresql(**kwargs):
    ...
    insert_query = """
    INSERT INTO raw_data.cybertrack_superapps_v_billpayment (
        "Id",
        "AccountID",
        "AccountName",
        "AccountType",
